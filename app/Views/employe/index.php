...
<body>
    ...
    <aside class="sidebar">
        ...
        <li><a href="/employe/index" class="active"><i class="bi bi-calendar3"></i> Mes demandes</a></li>
    ...
    <div class="main">
        ...
        <div class="topbar-actions">
            <a href="/employe/create" class="btn-forest" style="padding:7px 14px;font-size:.82rem"><i class="bi bi-plus-lg"></i> Nouvelle demande</a>
        </div>
        </div>
